...
<tr><td><font face="Arial" size="2"><br>レッドハットのサブスクリプション製品をご利用いただき誠にありがとうございます。</font></td></tr> 
...
すでに該当する下記のコントラクト・ナンバーのサブスクリプションを更新されている場合、もしくは更新しない旨をご通知いただいている場合には、ご案内が行き違いとなってしまい、大変申し訳ございません。その節は、お手数ながら当メールを破棄していただきますようお願い申し上げます。 
</font></td></tr> 
...
<c:otherwise>
<tr><td><font face="Arial" size="2"><br>
弊社登録情報によりますと、お客様のレッドハットサブスクリプションのサービス期間満了まで後0日となりましたので、サブスクリプションの更新についてご案内致します。 
</font></td></tr> 
</c:otherwise>
</c:choose>
...
<BR>&nbsp;<BR>
<a href ="https://www.redhat.com/apps/store/renew/" > <img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/redhat/button_renew_now.gif" border=0> </a> </font> </td></tr> 
...
<c:when test="${tpl_vals[1] == 'Direct'}">  
<tr><td><font face="Arial" size="2">
<br><br>下表は、現在ご使用いただいているサブスクリプション（Old SKU） とそれに対応する新体系を基調としたサブスクリプション（Configured SKU） の一例となります。
</font></td></tr>
...
<td align="center" valign="center" style="width:5%"> <font face="Arial" style="font-size:8pt">  <x:out select="$p/existing_po"/> </font> </td>
...
<tr><td><font face="Arial" size="2"> <br>弊社の新しいパッケージングについてのより詳しいご説明は、下記URLにて御覧頂けますので、ご利用ください。
<br>
<a href="http://www.jp.redhat.com/rhel/purchasing_guide.html">http://www.jp.redhat.com/rhel/purchasing_guide.html</a>
  </font></td></tr>
...
<tr><td><font face="Arial" size="2"><br>
現在ご使用になられているサブスクリプションでご利用できるサービス及び更新に必要な情報の詳細は、<a href ="http://jp.redhat.com/about/subscription/" >こちら</a>でご覧頂けます。 

</font></td></tr>

<tr><td><font face="Arial" size="2"><br>

更新手続き、サービスについてのより詳しい情報、または他のサービスについてのお問い合わせは、お客様の販売店にご連絡ください。販売店一覧は <a href ="http://jp.redhat.com/about/subscription/" >こちら</a>をご覧下さい。
</font></td></tr>



<tr><td><font face="Arial" size="2"><br>
レッドハットサブスクリプションについて、今後、ご連絡を差し上げるべき方が他にいらっしゃいましたら、恐れ入りますがご連絡先を <a href=mailto:renewal-jp-partners@redhat.com>renewal-jp-partners@redhat.com</a> までお知らせいただきますようお願い申し上げます。

</font><br></td></tr>
<tr><td><font face="Arial" size="2"><br>その他、ご不明な点がございましたら、下記までお問い合わせ頂きますようお願い申し上げます。
 <BR>
</font><br></td></tr>
<tr><td><font face="Arial" size="2">
レッドハット 更新担当
...
<tr><td><font face="Arial" size="2">
メールアドレス： <a href=mailto:renewal-jp-partners@redhat.com>renewal-jp-partners@redhat.com</a>
 </font><br></td></tr>
<tr><td><font face="Arial" size="2">
...
<c:when test="${tpl_vals[2] != 'minus30'}">
<tr><td><font face="Arial" size="2">
現在ご使用になられているサブスクリプションでご利用できるサービス及び更新に必要な情報の詳細は<a href ="http://jp.redhat.com/about/subscription/" >こちら</a>で御覧頂けます。
</font><br><br></td></tr>
<tr><td><font face="Arial" size="2">
...
<tr><td><font face="Arial" size="2">ご使用になられているサブスクリプションでご利用できるサービス及び更新に必要な事項の詳細は<a href ="http://jp.redhat.com/about/subscription/" >こちら</a>でご覧いただけます。
</font><br><br></td></tr>
