...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "tr" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/TR_T2RESELLER_EXPIRING_120.png"></td></tr>
...
<%-- LETTER BODY --%>
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">Yenileme Duyurusu,</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Aşağıdaki müsteri lisansınız sona eriyor. Son Müşterilere 90 gün, 60 gün, 30 ve 7 gün icerisinde yenileme hatırlatma e-posta alacaksınız.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Kişisel bilgilerinız e-postayla bildirilecektir.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Dağıtımcı adı</font></th>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Eğer yenilemeyi yapmıs iseniz bu duyuruyu dikkate almayinız.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Temsilciniz yenilemelerin gözden gecirmek icin sizinle irtibata gecicek.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Yenilime işlemi ile İlgili herhangi bir sorunuz olursa veya müşteri iletişim lütfen bizimle temas kurmaktan cekinmeyin.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
