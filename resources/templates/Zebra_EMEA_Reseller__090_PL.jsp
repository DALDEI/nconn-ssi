...
Oferta obejmuje nowe usługi, nowe opcje serwisowe i nowe 
korzyści.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Nie należy dopuścić do tego, żeby klient odkładał odnowienie umowy na ostatni dzień lub później – jeśli umowa nie zostanie odnowiona przed datą wygaśnięcia, spowoduje to przerwę w świadczeniu usług. Państwa klient nie będzie miał wówczas dostępu do usług świadczonych w ramach wybranego przez siebie pakietu serwisowego.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Podane niżej usługi, oferowane w ramach umowy serwisowej Zebra OneCare, zapewniają Państwa klientom optymalną pracę i dostępność urządzeń na wymaganym przez nich poziomie:
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Brak dostępu do tych usług może mieć wpływ na funkcjonowanie 
przedsiębiorstw Państwa klientów.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
pomocą – proszę o wiadomość.
  ...
  <tr><td><font face="Arial" size="2">
Jeśli odnowili już Państwo umowę, dziękuję bardzo 
i proszę o zignorowanie tej wiadomości. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
