...
src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/zebra_yellow_bar.png"></td></tr>
      </table>
    </td>
    <td>
...
under the service contract(s) listed below. The service features listed 
below are part of the Zebra OneCare offering which are helpful in 
maintaining desired levels of product uptime and availability.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="560" border="0">
  <tr>
    ...
    <td width="90%"><font face="Arial" size="2">OS, software and firmware 
...
updates</font></td>
  ...
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
    <td width="90%"><font face="Arial" size="2">Help desk support and 

troubleshooting</font></td>
  </tr>
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
  ...
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
    <td width="90%"><font face="Arial" size="2">Value added options included with the 
...
contract</font></td>
  ...
  <tr><td><font face="Arial" size="2">
Have your customers renew now to reinstate access to these 
important mission critical features.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="5" width="560" border="0">
  <tr bgcolor="5f4b7a">
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Contract 

Number</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">End 

User</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Expiry 
...
<a href=mailto:apac.renewals@zebra.com>apac.renewals@zebra.com</a>
  ...
  <tr><td><font face="Arial" size="2">
If you do not prefer to receive email renewal notifications from Zebra, 
please 
