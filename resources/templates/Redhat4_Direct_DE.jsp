...
Unseren Unterlagen zur Folge werden Ihre Red Hat Abonnements IN <c:out value="${stage}"/> TAGEN ABLAUFEN. Bitte achten Sie darauf, diese vor dem Ablaufdatum zu erneuern, um auch weiterhin in den Genuss der Vorteile Ihrer Abonnements, wie Zugriff auf Red Hat Software, Updates, Upgrades, technischen Support, sicherheitsrelevante Aktualisierungen sowie das Open Source Assurance Program von Red Hat, zu kommen. Bitte lesen Sie sich unbedingt die nachfolgenden Bedingungen durch, damit Sie die Konditionen Ihres Verlängerungsangebotes vollständig verstehen, da sich unsere Produktkonfigurationen geändert haben. Ich bin Ihr Red Hat Verkaufsberater und Sie können mich unter <a href=mailto:<x:out select="$d//client/rep_email"/>><x:out select="$d//client/rep_email"/></a>
 erreichen, wenn Sie Fragen haben.</font></td></tr>
</c:otherwise>
</c:choose>
...
<tr><td><font face="Arial" size="2">
<BR>
Wir möchten Sie außerdem darüber informieren, dass wir verschiedene Verbesserungen gemacht haben, damit Sie von Ihrem Red Hat Abonnement mehr Flexibilität und Nutzen erhalten. Somit erhalten Sie eine mehr an den Kunden angepasste und verbesserte Version Ihrer aktuellen Red Hat Lösung. Dieser Übergang beinhaltet neue, flexiblere Produktkonfigurationen, Produktnummern, Preise, Support-Ebenen und optionale Stufenprodukte. Als Folge der neuen Konfigurationen kann Ihr Preis für die Verlängerung von Ihrem ursprünglichen Kaufpreis abweichen.
</font></td></tr>
<tr><td><font face="Arial" size="2">
<BR>
Die folgende Tabelle zeigt die Zuordnung Ihres derzeitigen Abonnements zu unserer neuen Produktstrukturierung, welche Ihnen geliefert wird, wenn Sie Ihr Abonnement verlängern:
...
<th  align="Center" valign="center"><font face="Arial" size="2" color="ffffff">Bestell<BR>nummer</font></th>
...
<br>
<table cellspacing="0" cellpadding="0" width="660" border="0">
<tr><td><font face="Arial" size="2"> Weitere Informationen über unsere neue Produktstrukturierung finden Sie unter <a href ="http://www.redhat.com/rhel/renew/">http://www.redhat.com/rhel/renew/</a>.<br><br></font></td></tr>
...
<tr><td><font face="Arial" size="2"> <a href ="http://www.redhat.com/subscriptions/" >Hier</a> können Sie mehr über die Vorteile und Voraussetzungen für die Verlängerung Ihres Red Hat Abonnements erfahren.
</font><br><br></td></tr>


<tr><td><font face="Arial" size="2">Wenn Sie glauben, jemand anderes sollte künftige Mitteilungen über Ihre Red Hat-Abonnements erhalten, schicken Sie bitte eine E-Mail mit näheren Einzelheiten an <a href=mailto:customerdata-emea@redhat.com>customerdata-emea@redhat.com</a>. Bitte geben Sie darin unbedingt Ihre Red Hat Login-ID sowie Ihre Vertragsnummer an.</font><br></td></tr> 

<tr><td><font face="Arial" size="2"><br> Wenn Sie weitere Informationen benötigen oder mehr über unsere anderen Dienste erfahren möchten, können Sie auch unter <a href="http://www.redhat.com/about/contact/dir/">http://www.redhat.com/about/contact/dir/</a>
 mit mir Kontakt aufnehmen. <br><br><br></font> </td></tr> 
