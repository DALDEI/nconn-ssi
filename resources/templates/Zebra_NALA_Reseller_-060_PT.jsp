...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "pt" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
<b>O seu Contrato de Serviço Zebra expirou!</b>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
As funcionalidades de serviço listadas abaixo fazem parte da oferta Zebra 
OneCare que mantém os níveis de execução e disponibilidade de produto 
...
<table cellspacing="0" cellpadding="0" width="560" border="0">
  <tr>
    ...
    <td width="90%"><font face="Arial" size="2">Atualizações de software e firmware</font></td>
  </tr>
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
  ...
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
    <td width="90%"><font face="Arial" size="2">Cobertura abrangente</font></td>
  </tr>
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
    <td width="90%"><font face="Arial" size="2">Reparação ou substituição de hardware</font></td>
  </tr>
  <tr>
    <td width="5%"><font face="Arial" size="2">&nbsp;</font></td>
    <td valign="top" width="5%"><font face="Arial" size="2">•</font></td>
    <td width="90%"><font face="Arial" size="2">Opções de valor acrescentado incluídas no contrato</font></td>
  </tr>
</table>
...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Mas não é demasiado tarde para voltar a aplicar o contrato para aceder a 
estas funções de importância crítica! Vá a 
<a href="http://www.zebra.com/zebraonecare">www.zebra.com/zebraonecare</a> 
onde irá encontrar as opções disponíveis para o seu cliente. Existem novos serviços, 
novas opções de serviço e novos benefícios a experimentar.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Entre em contacto comigo com quaisquer questões que tiver e poderemos 
discutir as opções disponíveis.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Já preparámos um orçamento de renovação para si no nosso site de 
renovações de contrato:
<a href="http://renewals.connectpartnerportal.com/">
http://renewals.connectpartnerportal.com/</a>. 
Inicie sessão com a informação de utilizador que fornecemos anteriormente. 
Se nunca iniciou sessão no nosso portal de parceiro, não hesite em 
contactar-me para obter ajuda.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Se já renovou o contrato, obrigado por fazê-lo e queira ignorar esta notificação.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<x:out select="$d//opp_ssirep_email"/></a>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
NOTA: Não responda a este e-mail; ele foi gerado eletronicamente e esta caixa de correio não é monitorada.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
