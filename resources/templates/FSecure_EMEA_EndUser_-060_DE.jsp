...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "de" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/GER_EU_EXPIRED_-60.png"></td></tr>
...
vielen Dank, dass Sie sich für unsere Produkte entschieden haben.
  ...
  <tr><td><font face="Arial" size="2">
Wir möchten Sie darauf hinweisen, dass die unten aufgeführten Lizenzen bereits abgelaufen sind. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Bitte verlängern Sie Ihre Lizenzen unverzüglich, um weiterhin geschützt zu sein und Produktupdates, sowie Support und Wartungsservice von F-Secure zu erhalten.
</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Falls Sie kürzlich Ihre Lizenzen verlängert haben, bitte ignorieren Sie dieses Email.</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
