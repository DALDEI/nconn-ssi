...
<table cellspacing="0" cellpadding="0" width="660" border="0">
<tr><td><font face="Arial" size="2"><br>We thought you would like to know that your Red Hat subscriptions detailed in the schedule below 
<c:choose>
...
Please be sure to renew them <c:choose><c:when test="${tpl_vals[2] == '0' || tpl_vals[2] == 'minus30'}">right away</c:when><c:otherwise>before the expiration date</c:otherwise></c:choose> to continue to receive the benefits of your subscriptions, including access to Red Hat software, updates, upgrades, technical support, security fixes, and Red Hat's Open Source Assurance Program. Please be sure to read the terms below to fully understand the terms of your renewal offer as our product configurations have changed.

<c:choose>
<c:when test="${tpl_vals[0] == 'EMEA' && (account_status == 'Named Account' || account_status == 'Exception Account')}"> 
If you have any questions I am your Red Hat sales representative and you can reach me at <a href=mailto:<c:out value="${ssirepemail}"/>><c:out value="${ssirepemail}"/></a>.
</c:when>
</c:choose>
...
<BR>In order to continue to receive the benefits of your subscription, please contact your Reseller, or alternatively contact our renewals team at <a href=mailto:renewals-emea@redhat.com>renewals-emea@redhat.com</a>. </font></td></tr>
</c:when>

<c:when test="${tpl_vals[0] == 'NALA' && (account_status != 'Named Account' && account_status != 'Exception Account')}">
<tr><td><font face="Arial" size="2">
<BR>
In order to continue to receive the benefits of your subscription, please contact your Reseller, or alternatively contact our Partner Team at 
  <a href=mailto:<c:out value="${partner_team_email}"/>><c:out value="${partner_team_email}"/></a>.</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
<tr><td><font face="Arial" size="2"><br>More information about our new product structure is available by visiting, <a href ="http://www.redhat.com/rhel/renew/"> http://www.redhat.com/rhel/renew/ </a> <br><br></font></td></tr>

<tr><td><font face="Arial" size="2">
Your Red Hat subscriptions provide you with continuous value to help solve your business problems every day. Red Hat measures this value based upon the number of systems running Red Hat software, so during the term of your agreement with Red Hat (i.e., while you have any active subscriptions), you are required to maintain a subscription for every installation/instance of Red Hat software. Only with these active subscriptions you have access to:
 <br><br></font></td></tr>
...
<tr><td><font face="Arial" size="2">
You can learn more about the benefits and renewal requirements of your Red Hat subscription <a href= "http://www.redhat.com/subscriptions/">here</a>. If you require any additional information, or information on our other services, please contact your reseller.
...
<c:when test="${tpl_vals[0] == 'EMEA'}" > 
   ...
   <c:choose>
     ...
     <tr><td><font face="Arial" size="2">
If you do not have a preferred supplier of Red Hat products, please contact our renewals team at <a href=mailto:renewals-emea@redhat.com>renewals-emea@redhat.com</a>, and we will be happy to connect you with an appropriate Red Hat reseller.
     </font><br><br></td></tr>

<tr><td><font face="Arial" size="2">
If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to <a href=mailto:to renewals-emea@redhat.com>renewals-emea@redhat.com</a>. Please be sure to include your Red Hat Login ID and your contract number.
</font><br><br></td></tr>
...
<tr><td><font face="Arial" size="2">
If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to <a href=mailto:customerdata-emea@redhat.com>customerdata-emea@redhat.com</a>. Please be sure to include your Red Hat Login ID and your contract number.
</font><br><br></td></tr>
   </c:when>
   </c:choose>
...
If you do not have a preferred supplier of Red Hat products, please contact our Partner Team at <a href=mailto:<c:out value="${partner_team_email}"/>><c:out value="${partner_team_email}"/></a>, and we will be happy to connect you with an appropriate Red Hat reseller.<BR><BR></font></td></tr>

<tr><td><font face="Arial" size="2">If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to <a href=mailto:<c:out value="${chng_email_not}"/>><c:out value="${chng_email_not}"/></a>. Please be sure to include your Red Hat Login ID and your contract number.<BR><BR></font></td></tr>
</c:otherwise>
</c:choose>


<tr><td><font face="Arial" size="2">We are pleased to support you. <BR><BR><br></font></td></tr>
<tr><td><font face="Arial" size="2">Yours Sincerely,<br><br><br></font></td></tr>
...
<tr><td><font face="Arial" size="2">The Red Hat Renewals Team<br><br><br></font></td></tr>
</c:otherwise>
</c:choose>
