...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "fr" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/FR_EU_EXPIRED_-60.png"></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
Merci d’utiliser les produits sécurité de F-Secure.
  ...
  <tr><td><font face="Arial" size="2">
Selon notre base de données les licences F -Secure ci-dessous ont expirés. Merci de renouveler vos licences pour rester protégé et recevoir les mises à jour de produits ainsi que des services de support F –Secure.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
