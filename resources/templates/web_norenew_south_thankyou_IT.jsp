...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">		<title></title>
		<style type="text/css"> <%-- P {font-family: verdana, helvetica; font-size: 12px; font-weight: normal; color: #000000}
	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>La ringraziamo per questa informazione. Un rappresentante di F5 contatterà quanto prima il rivenditore da lei indicato per ottenere i dettagli del rinnovo manutenzione F5.</p>
 <br /><br />
		...
		<table border="0" cellspacing="0" cellpadding="10" width="640" id="Table6">
			<tr bgcolor="#ffffff">
				<td bgcolor="#ffffff"><p><span class="pfooter"><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/F5/F5_logo.jpg" alt="F5 Logo"></span><span class="pfooter"></span></p>
				</td>
			</tr>
		</table>
		<%-- END FOOTER --%>
