...
<tr><td style="font-family:Calibri,sans-serif;font-size:10pt">A RedHat Renewal notification did not reach its intended recipient:<br><br></td></tr>
...
<tr><td style="font-family:Calibri,sans-serif;font-size:10pt">Contract Number: <x:out select="$d//contract_no[1]"/><br><br></td></tr>
