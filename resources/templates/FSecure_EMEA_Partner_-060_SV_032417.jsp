...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "sv" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/SWE_PARTNER_EXPIRED_-60.png"></td></tr>
...
<%-- LETTER BODY --%>
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">Bäste Partner</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Följande Kund Licenser har löpt ut.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Slutkunderna som är kontaktbara får förnyelse påminnelse mejl 90 dagar, 30 dagar och 7 dagar före utgångsdatum.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Era utvalda kontaktuppgifter kommer att bifogas I dessa e-postmeddelanden.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Åter-försäljare</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Slutkund</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">SKU</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Produkt Namn</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Antal</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Utgångs datum</font></th>
  </tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Din dedikerade förnyelse representant kommer kontakta dig inom kort för att disskutera utlöpnande licenseravtal och säkerställa att du har tillgång till stöd och information.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Tveka inte att kontakta oss om du har några frågor om förnyelseprocessen eller kundkommunikation. 
  ...
  <tr><td><font face="Arial" size="2">
Med Vänliga Hälsningar, <b><x:out select="$d//opp_ssirep_fullname"/></b>
  </font></td></tr>

  <tr><td><font face="Arial" size="2">
F-Secure förnyelse Team
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
