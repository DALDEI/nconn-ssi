	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>Pouvez-vous préciser les raisons pour lesquelles votre entreprise a décidé de ne pas renouveler?</p>
 <br />
 <br />
		...
		<input name="_event" type="hidden" size="40" value="FormEvent.no_renewal">		  	  
				  <input name="_redirect" type="hidden" size="40" value='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "web_norenew_thankyou_FR" ) %>'>
                  <table>
				  <tr>
				  <td></td><td>
<select size="1" name="no_service_code">
<option value="SCB" SELECTED>Décision du client en relation du coüt</option>
<option value="SSD">Décision Client pour raison de satisfaction</option>
<option value="PPD">Le produit n'est plus utilisé</option>
<option value="PTR">Remplacé par un produit F5</option>
<option value="PCP">Produit remplacé par produit concurrent</option>
</select>
