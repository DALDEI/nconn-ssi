	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>Can you please specify the reason why your company has decided not to renew?</p>
 <br />
 <br />
		...
		<input name="_event" type="hidden" size="40" value="FormEvent.no_renewal">		  	  
				  <input name="_redirect" type="hidden" size="40" value='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "web_norenew_thankyou_IN" ) %>'>
                  <table>
				  <tr>
				  <td></td><td>
<select size="1" name="no_service_code">
<option value="SCB" SELECTED>CUSTOMER COST-BENEFIT DECISION</option>
<option value="SSD">CUSTOMER SATISFACTION DRIVEN</option>
<option value="PPD">PRODUCT DECOMMISSIONED</option>
<option value="PTR">CLIENT PRODUCT REPLACEMENT</option>
<option value="PCP">COMPETITIVE PRODUCT REPLACEMENT</option>
</select>
