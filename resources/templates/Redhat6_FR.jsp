...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Les abonnements Red Hat suivants expireront dans <c:out value="${tpl_stage}"/> 
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Vos abonnements Red Hat sont d'une utilité constante et aident votre entreprise au 

quotidien. Seuls les abonnements Red Hat actifs vous permettent de bénéficier :</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>D'une sécurité renforcée :  </b>L'équipe Red Hat chargée de la sécurité a fourni des correctifs pour plus de 98 

% des vulnérabilités critiques au cours des 24 heures ayant suivi l'identification du problème.</li>
      <li><b>D'une assistance primée :  </b>L'assistance technique Red Hat est disponible 24 heures sur 24 dans le monde 

entier. En outre, la base de connaissances, les études de cas et les architectures de référence sont disponibles via le 

portail des clients Red Hat.</li>
      <li><b>De mises à jour et mises à niveau gratuites :  </b>Votre abonnement vous donne accès aux mises à jour logiciels 

ainsi qu'à toutes leurs versions courantes Red Hat.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Pour en savoir plus sur les avantages de votre abonnement Red Hat, rendez-vous sur 
<a href ="http://red.ht/1EGEUMm" >http://red.ht/1EGEUMm</a>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Assurez-vous de disposer des informations suivantes lorsque vous nous contactez 
...
© 2015 Red Hat, Inc. Tous droits réservés. Red Hat, Red Hat Enterprise Linux, le logo Shadowman et JBoss sont des 

marques de Red Hat, Inc., déposées aux États-Unis et dans d'autres pays. Linux® est la marque commerciale déposée de 

Linus Torvalds aux États-Unis et dans d'autres pays. Toutes les autres marques appartiennent à leurs propriétaires 
