...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "ja" , "" ) %>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">
<b>Zebra サービス期間の終了について</b>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
下記お客様につきましてサービス期間の終了が近づいております。是非この機会に更新のご提案をお願いいたします。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
にアクセスして、新しいサービスやオプション、利点などを確認してください。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
サービス期間中であれば適切なサービスを継続して受けていただくことができますので、サービス期間終了日やそれ以降にならないよう、サービス期間中に契約を延長していただくようご提案ください。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
下記はZebra OneCare が提供している製品の稼働時間や入手可能な状態についてお客様が希望されるサービス内容の一部です。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
サービスが受けられなくなることは、お客様にとっても大きな損失です。 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
必要なオプションに関して質問がありましたら、是非ご連絡ください。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
更新に必要な見積もりなどは下記サイトにご用意しております。 
<a href="http://renewals.connectpartnerportal.com/">http://renewals.connectpartnerportal.com/</a>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
事前に提供させていただきましたログイン情報で、アクセスしてください。パートナーポータルへのアクセスが今回初めてという場合も、サポートいたしますので、お気軽にご連絡ください。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
既にサービス更新のご提案をされている場合は、行き違いとなりましたことをお詫びいたします。
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
不明な点がございましたら、是非お問い合わせください。
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">親展</font></td></tr>
  <tr><td><font face="Arial" size="2">
...
<a href="mailto:apac.renewals@zebra.com">apac.renewals@zebra.com</a>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
サービス期間のお知らせメールについて、配信停止をご希望の方
<a href='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "Zebra_Unsubscribe_Acknowledgement_JA" ) %>'>
はこちらをクリック
</a>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
