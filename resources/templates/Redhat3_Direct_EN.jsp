...
<tr><td><font face="Arial" size="2">
<br>
The following table shows the mapping of your current subscription to our new product structure, which will be delivered to you as you renew your subscription:<br>&nbsp<br><br></font></td></tr>
...
<c:choose><c:when  test="${tpl_vals[0] == 'EMEA'}">
<tr><td><font face="Arial" size="2">
If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to <a href=mailto:customerdata-emea@redhat.com>customerdata-emea@redhat.com</a>. Please be sure to include your Red Hat Login ID and your contract number.<BR></font></td></tr>
...
If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to
 ...
 <a href=mailto:<c:out value="${chng_email_not}"/>><c:out value="${chng_email_not}"/></a>. Please be sure to include your Red Hat Login ID and your contract number.
<BR></font></td></tr>
