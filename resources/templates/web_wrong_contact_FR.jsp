	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
	      <td>
                ...
                <p><br />
  Merci de mettre à jour les contacts de ce contrat.</p>
                <p>&nbsp;</p>
                <form name="corrected" method="post" action='<%=nexstra.cds.servlet.TemplateTags.getFormPostURL( request , pageContext ) %>' onsubmit="return validate_form(this);">
				  ...
				  <input name="_redirect" type="hidden" size="40" value='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "web_update_thankyou_FR" ) %>'>
                  <table>
				  <tr>
				  <td width="160">Nom du contact </td><td width="325"><input name="cname" type="text" size="40" value='<c:out value="${values.contact_name}"/>'></td>
				  </tr>
				  <tr>
