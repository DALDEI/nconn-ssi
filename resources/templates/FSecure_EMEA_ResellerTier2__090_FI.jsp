...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "fi" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/FIN_T2RESELLER_EXPIRING_120.png"></td></tr>
...
<%-- LETTER BODY --%>
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">Hyvä yhteistyökumppani</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Alla olevien asiakkaittenne lisenssit ovat päättymässä. Tietoturvaohjelmiston käyttöoikeus jatkuu keskeytyksettä vain uusimalla lisenssit pikaisesti. Varmista, että asiakkaasi pysyvät suojattuna 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Asiakkaat ovat saaneet teidän yhteystietonne sisältävän tiedotteen sähköpostilla 90, 30 ja 7 päivää ennen lisenssien päättymistä sekä vielä päivä päättymisen jälkeen.
  ...
  <tr><td><font face="Arial" size="2">
Teidän yhteystiedot toimitetaan noiden tiedotteiden mukana.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Mikäli olette jo uusineet lisenssinne, muistutus on aiheeton.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Tukku-kauppias</font></th>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Lisenssimäärä</font></th>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Mikäli teillä on kysyttävää lisenssien uusimisesta, otattehan meihin yhteyttä.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  ...
  <tr><td><font face="Arial" size="2">
Puhelin, toimisto : <b><x:out select="$d//opp_ssirep_phone"/></b>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
