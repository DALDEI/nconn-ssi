	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>Può indicarci il rivenditore attraverso cui avete rinnovato il support F5?</p>
 <br />
 <br />
		...
		<input name="_event" type="hidden" size="40" value="FormEvent.already_renewed_south">		  	  
				  <input name="_redirect" type="hidden" size="40" value='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "web_already_renewed_south_IT" ) %>'>
                  <table>
