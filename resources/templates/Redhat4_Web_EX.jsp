...
<tr><td><font face="Arial" size="2">
Según nuestros registros, sus subscripciones a Red Hat caducan hoy. Por favor, segúrese de renovar sus suscripciones inmediatamente para seguir recibiendo los beneficios de sus suscripciones, incluyendo el acceso al software de Red Hat, actualizaciones, mejoras, nuevas versiones, soporte técnico, revisiones de seguridad y el Programa de Seguridad Open Source de Red Hat. Asegúrese de leer los términos y condiciones de más abajo para entender completamente los términos de su oferta de renovación cuando cambien nuestras configuraciones de producto. 
...
<tr><td><font face="Arial" size="2">
<BR>
Según nuestros registros, sus subscripciones a Red Hat caducan dentro de <c:out value="${stage}"/> días. Por favor, segúrese de renovar sus suscripciones inmediatamente para seguir recibiendo los beneficios de sus suscripciones, incluyendo el acceso al software de Red Hat, actualizaciones, mejoras, nuevas versiones, soporte técnico, revisiones de seguridad y el Programa de Seguridad Open Source de Red Hat. Asegúrese de leer los términos y condiciones de más abajo para entender completamente los términos de su oferta de renovación cuando cambien nuestras configuraciones de producto. </font></td></tr>

</c:otherwise>
</c:choose>
<tr><td><font face="Arial" size="2"> 
<BR>&nbsp;<BR>
Haga clic aquí para <a href ="https://www.redhat.com/apps/store/renew/" > <img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/redhat2/button_renew_now_ES.gif" border=0> </a> <br><br></font> </td></tr> 
...
<tr><td><font face="Arial" size="2">
Si cree que alguien más debe recibir notificaciones futuras sobre sus suscripciones Red Hat, envíe los datos a <a href=mailto:customerservice-latam@redhat.com >customerservice-latam@redhat.com</a>. Asegúrese de incluir su identificación de acceso de Red Hat y su número de contrato. 


 <BR>
</font><br></td></tr>
<br><tr><td><font face="Arial" size="2"> 
Estaremos encantados de ayudarle. <br><br></font>  </td></tr>

<tr><td><font face="Arial" size="2"> <br>&nbsp;<br>Atentamente,<br><br></font> </td></tr> 
<br><br><tr><td><font face="Arial" size="2"> 
