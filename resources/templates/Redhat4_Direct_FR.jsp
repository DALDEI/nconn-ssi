...
<tr><td><font face="Arial" size="2"><br>Je vous remercie d'avoir choisi les solutions de Red Hat. <br> <br> </font></td></tr> 

<c:choose>
<c:when test="${tpl_vals[2] == 'minus30'}"> 
 
<tr><td><font face="Arial" size="2">
Selon nos archives, vos abonnements de Red Hat ont expiré. Veuillez vous assurer de leur renouvellement immédiat pour continuer à recevoir les avantages de vos abonnements, notamment l'accès au logiciel Red Hat, aux mises à jour, aux mises à niveau, au soutien technique, aux correctifs de sécurité et au programme Assurance Open Source de Red Hat. Veuillez vous assurer de lire les conditions ci-dessous pour comprendre parfaitement les conditions de votre offre de renouvellement car nos configurations de produit ont changé. Si vous avez des questions, je suis votre représentant de ventes Red Hat, et vous pouvez me joindre à <a href=mailto:<x:out select="$d//client/rep_email"/>><x:out select="$d//client/rep_email"/></a>.</font></td></tr>
...
<tr><td><font face="Arial" size="2">
Selon nos archives, vos abonnements de Red Hat VONT EXPIRER AUJOURD'HUI. Veuillez vous assurer de leur renouvellement immédiat pour continuer à recevoir les avantages de vos abonnements, notamment l'accès au logiciel Red Hat, aux mises à jour, aux mises à niveau, au soutien technique, aux correctifs de sécurité et au programme Assurance Open Source de Red Hat. Veuillez vous assurer de lire les conditions ci-dessous pour comprendre parfaitement les conditions de votre offre de renouvellement car nos configurations de produit ont changé. Si vous avez des questions, je suis votre représentant de ventes Red Hat, et vous pouvez me joindre à <a href=mailto:<x:out select="$d//client/rep_email"/>><x:out select="$d//client/rep_email"/></a>.
...
<tr><td><font face="Arial" size="2">
<BR>
Selon nos archives, vos abonnements de Red Hat VONT EXPIRER DANS <c:out value="${stage}"/> JOURS. Veuillez vous assurer de leur renouvellement avant la date d'expiration pour continuer à recevoir les avantages de vos abonnements, notamment l'accès au logiciel Red Hat, aux mises à jour, aux mises à niveau, au soutien technique, aux correctifs de sécurité et au programme Assurance Open Source de Red Hat. Veuillez vous assurer de lire les conditions ci-dessous pour comprendre parfaitement les conditions de votre offre de renouvellement car nos configurations de produit ont changé. Si vous avez des questions, je suis votre représentant de ventes Red Hat, et vous pouvez me joindre à <a href=mailto:<x:out select="$d//client/rep_email"/>><x:out select="$d//client/rep_email"/></a>.
...
<tr><td><font face="Arial" size="2">
<BR>
Nous aimerions également vous informer que nous avons fait plusieurs améliorations pour vous offrir plus de souplesse et de valeur pour votre abonnement Red Hat. Cela vous permettra de bénéficier d'une version améliorée, plus personnalisée par rapport à votre solution actuelle Red Hat. Cette transition comprend de nouvelles configurations de produits plus souples, de nombreux produits, une tarification, des niveaux de soutien et des produits stratifiés facultatifs. À la suite de la nouvelle configuration, votre prix de renouvellement peut varier de votre prix d'achat original. 
</font></td></tr>
<tr><td><font face="Arial" size="2">
<BR> 
Le tableau suivant montre le mappage de votre abonnement actuel vers notre nouvelle structure de produit, qui vous sera accessible dès que vous renouvèlerez votre abonnement: <BR>&nbsp;<BR>
</font></td></tr>
...
<th  align="Center" valign="center"><font face="Arial" size="2" color="ffffff">Numéro<br> de bon de<br> commande</font></th>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
<tr><td><font face="Arial" size="2">
Plus d'informations sur notre nouvelle structure de produit sont disponibles en visitant, <a href ="http://www.redhat.com/rhel/renew/">http://www.redhat.com/rhel/renew/</a>.</font><br><br></td></tr>


<tr><td><font face="Arial" size="2">Vos abonnements Red Hat vous fournissent une valeur continue pour vous aider à résoudre vos problèmes professionnels tous les jours. Red Hat mesure cette valeur en fonction du nombre de systèmes exécutant le logiciel Red Hat, donc pendant la durée de votre contrat avec Red Hat (c.-à-d., quand vous avez les abonnements actifs), vous êtes tenu de maintenir un abonnement pour chaque installation/instance du logiciel Red Hat. Uniquement quand ces abonnements sont actifs, vous avez accès à: <br><br></font></td></tr>
<tr><td><font face="Arial" size="2"> 
<ul>
<li>
...
<tr><td><font face="Arial" size="2">Vous pouvez en apprendre plus sur les avantages et les exigences relatives au renouvellement de votre abonnement Red Hat <a href ="http://www.redhat.com/subscriptions/" >ici</a>.
</font><br><br></td></tr>

<tr><td><font face="Arial" size="2">Si vous pensez que quelqu'un d'autre pourrait être intéressé pour recevoir des avis au sujet de vos abonnements Red Hat, veuillez envoyer un courriel contenant ces informations à <a href=mailto:customerdata-emea@redhat.com > customerdata-emea@redhat.com</a>. Veuillez vous assurer d'inclure votre ID de connexion Red Hat et votre numéro de contrat. 
 <BR>
</font><br></td></tr>

<tr><td><font face="Arial" size="2">Si vous avez besoin de toute information supplémentaire, ou si vous souhaitez en apprendre davantage sur nos autres services, vous pouvez également me contacter au  <a href="http://www.redhat.com/about/contact/dir/">http://www.redhat.com/about/contact/dir/</a>
