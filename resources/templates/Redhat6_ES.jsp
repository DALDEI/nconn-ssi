...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones con Red Hat caducarán dentro de <c:out 

value="${tpl_stage}"/> días.</font></td></tr>
    </c:otherwise> 
  </c:choose>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Las suscripciones de Red Hat le proporcionan un valor continuo a su negocio. Con las suscripciones de Red Hat activas 
...
tiene acceso a:
  ...
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Seguridad: </b>Nuestro equipo de ingeniería ha solucionado más del 98% de las vulnerabilidades críticas en el 

plazo de un día natural a partir de la identificación del problema.</li>
      <li><b>Soporte galardonado: </b>El soporte técnico de Red Hat está disponible 24 horas al día en todo el mundo. 

Además puede acceder a la base de conocimiento, a los casos prácticos y a las arquitecturas de referencia disponibles 

mediante el Portal de clientes de Red Hat.</li>
      <li><b>Actualizaciones: </b>Las suscripciones le dan acceso a cualquier versión soportada de software de Red Hat, 

incluidas las actualizaciones entre versiones.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Descubra todas las ventajas de las suscripciones a Red Hat en 
<a href ="http://red.ht/1EGEUMm">http://red.ht/1EGEUMm</a>
  ...
  <tr><td><font face="Arial" size="2">Tenga esta información a mano cuando se ponga en contacto con 
...
© 2015 Red Hat, Inc. Todos los derechos reservados. Red Hat, Red Hat Enterprise Linux, el logotipo Shadowman y JBoss 

son marcas comerciales de Red Hat, Inc. registradas en Estados Unidos y en otros países. Linux® es la marca comercial 

registrada de Linus Torvalds en EE. UU. y en otros países. Las demás marcas registradas son propiedad de sus 
