...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Aşağıdaki Red Hat Subscription’ları <c:out value="${tpl_stage}"/> gün sonra sona 
...
Red Hat ile şu adresten iletişime geçerek Red Hat Subscription’larınızı yenileyebilirsiniz <c:out value="${partner_text}"/> 
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Red Hat Subscription’larınız sürekli olarak işinizde size her gün yardımcı olacak 

değerler sunar. Yalnızca etkin Red Hat Subscription’ları size aşağıdakilere erişim sağlar:</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Güvenlik: </b>Red Hat’in Güvenlik Müdahale Ekibi kritik zayıf noktaların %98'inden fazlasını tespit edildikleri 

andan itibaren bir takvim günü içinde çözmüştür.</li>
      <li><b>Limitsiz Teknik Destek:  </b>Red Hat, Red Hat Müşteri Portalı üzerinden bilgi tabanı, vaka çalışmaları ve referans 

mimarisi ile tüm dünyada günün 24 saati teknik destek sağlar.</li>
      <li><b>Ücretsiz güncelleme ve yükseltmeler: </b>Subscription sayesinde Red Hat yazılımının desteklenen herhangi bir 

sürümüne ve bu sürümlere ait her türlü güncellemeye erişiminiz olur.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Red Hat Subscription avantajları hakkında ayrıntılı bilgiye şu adresten ulaşabilirsiniz: 
...
© 2015 Red Hat, Inc. Tüm Hakları Saklıdır. Red Hat, Red Hat Enterprise Linux, Shadowman logosu ve JBoss ABD'de ve 

diğer ülkelerde Red Hat, Inc.in tescilli. ticari markalarıdır.Linux®, ABD'de ve diğer ülkelerde Linus Torvalds'ın tescilli and other 

coun ticari markasıdır.Tüm diğer ticari markalar ilgili sahiplerine aittir.
  </font> </td></tr> 
</table>
