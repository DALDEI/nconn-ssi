...
<tr><td><font face="Arial" size="2">저희의 시스템에 따르면, 귀사에서 사용하고 있는 Red Hat 서브스크립션이 만료되였습니다. 귀사에 제공되는 소프트웨어 업데이트, 업그레이드, 기술지원, 보안대책을 포함한 Red Hat's Open Source Assurance Program을 아무런 제한없이 사용하기 위해서는 유효기간이 만료되기 전에 귀사의 Red Hat 서브스크립션을 갱신하셔야 합니다. 아래와 같이 귀사의 서브스크립션을 갱신하시면 귀사에서 현재 사용하고 계시는 솔루션보다 향상된 기능의 솔루션 버전을 제공할 것입니다.<br> <br> </font></td></tr> 
</c:when>
...
<c:otherwise>
<tr><td><font face="Arial" size="2">저희의 시스템에 따르면, 귀사에서 사용하고 있는 Red Hat 서브스크립션이 <c:out value="${stage}"/> 일내에 만료됩니다. 귀사에 제공되는 소프트웨어 업데이트, 업그레이드, 기술지원, 보안대책을 포함한 Red Hat's Open Source Assurance Program을 아무런 제한없이 사용하기 위해서는 유효기간이 만료되기 전에 귀사의 Red Hat 서브스크립션을 갱신하셔야 합니다. 아래와 같이 귀사의 서브스크립션을 갱신하시면 귀사에서 현재 사용하고 계시는 솔루션보다 향상된 기능의 솔루션 버전을 제공할 것입니다.<br> <br> </font></td></tr>

</c:otherwise>
</c:choose>

<tr><td><font face="Arial" size="2"> 
Click Here to  <a href ="https://www.redhat.com/apps/store/renew/" > <img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/redhat2/button_renew_now.gif" border=0> </a> <br><br></font> </td></tr> 

<tr><td><font face="Arial" size="2">저희는 이 기회를 통해 저희 고객의 피드백을 기반으로 하여, 귀사에서 사용하고 계시는 Red Hat 서브스크립션에 대하여 더 나은 적응성과 가치를 제공하기 위하여, 여러가지를 향상 시켰다는 것을 알려드리고 합니다. 저희 제품은 보다 유연한 제품 구성, 제품 번호, 가격, 기술지원 수준 및 선택할수있는 서비스 레벨로 향상된 솔루션을 제공해드립니다. 제품의 구성변경으로 인해 귀사에서 지난해 구매하셨던 가격보다 약간의 변동이 있으실수 있습니다.
<br> <br> </font></td></tr> 
<tr><td><font face="Arial" size="2">
...
<tr><td><font face="Arial" size="2">귀사의 다른 분이 Red Hat 서브스크립션에 관한 공지 안내문을 받아보셔야 한다고 생각되시면, Red Hat 로그인 아이디 및 계정번호를 포함한 자세한 사항을 <a href=mailto:customerdata-apac@redhat.com>customerdata-apac@redhat.com</a>으로 보내주십시요. <BR></font><br></td></tr>


<tr><td><font face="Arial" size="2">Red Hat은 귀사를 지원하게 되어 대단히 기쁘게 생각하며 감사의 말씀을 드립니다.<br><br><br></font>  </td></tr>

<tr><td><font face="Arial" size="2">감사합니다,<br><br><br></font></td></tr>

<tr><td><font face="Arial" size="2"> Red Hat Renewals Team</font> </td></tr> 
