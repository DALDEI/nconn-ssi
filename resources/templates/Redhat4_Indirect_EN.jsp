...
<tr><td><font face="Arial" size="2">
<BR>In order to continue to receive the benefits of your subscription, please contact <a href=mailto:<x:out select="$d//client/rep_email"/>><x:out select="$d//client/rep_email"/></a>.   </font></td></tr>
</c:when>
...
<tr><td><font face="Arial" size="2">
If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to  <a href=mailto:renewals-emea@redhat.com>renewals-emea@redhat.com</a>. Please be sure to include your Red Hat Login ID and your contract number.
</font><br><br></td></tr>
...
<tr><td><font face="Arial" size="2">
If you think someone else should receive future notices about your Red Hat subscriptions, please email the details to  <a href=mailto:customerservice-latam@redhat.com>customerservice-latam@redhat.com</a>. Please be sure to include your Red Hat Login ID and your contract number.
</font><br><br></td></tr>
