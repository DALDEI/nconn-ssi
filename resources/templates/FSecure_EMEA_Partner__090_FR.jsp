...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "fr" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/FR_PARTNER_EXPIRING_120.png"></td></tr>
...
Vos coordonnées seront communiquées dans ces e-mails.
  ...
  <tr><td><font face="Arial" size="2">
Si vous avez déjà renouvelé cos licences, merci de ne pas tenir compte de cet email.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Nom du revendeur</font></th>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Votre interlocuteur F-Secure habituel vous contactera prochainement pour s’assurer que vous avez tous les éléments nécessaires.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
