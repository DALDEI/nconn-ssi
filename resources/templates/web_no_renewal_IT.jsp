	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>Può per favore specificare la ragione per cui la sua azienda ha deciso di non rinnovare la manutenzione?</p>
 <br />
 <br />
                <form name="corrected" method="post" action='<%=nexstra.cds.servlet.TemplateTags.getFormPostURL( request , pageContext ) %>'>
		<input name="_event" type="hidden" size="40" value="FormEvent.no_renewal">		  	  
				  <input name="_redirect" type="hidden" size="40" value='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "web_norenew_thankyou_IT" ) %>'>
                  <table>
				  <tr>
				  <td></td><td>
<select size="1" name="no_service_code">
<option value="SCB" SELECTED>Decisione legata al prezzo</option>
<option value="SSD">Decisione legata alla soddisfazione dell’utente finale</option>
<option value="PPD">Prodotto decomissionato</option>
<option value="PTR">Prodotto sostituito da un altro prodotto F5</option>
<option value="PCP">Prodotto sostituito da un prodotto concorrenziale</option>
</select>


</td></tr><tr><td>Comments:</td><td><textarea name="comments" rows=5 cols=40></textarea></td>
				  </tr>
				  <tr>
				    <td>&nbsp;</td>
