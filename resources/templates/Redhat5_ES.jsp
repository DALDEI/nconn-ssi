...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    <c:when test="${tpl_stage == 'minus30'}"> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones con Red Hat han caducado.</font></td></tr> 
    </c:when>
    <c:when test="${tpl_stage == '0'}"> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones con Red Hat caducan hoy.</font></td></tr> 
    </c:when>
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones con Red Hat caducarán dentro de <c:out value="${tpl_stage}"/> días.</font></td></tr>
    </c:otherwise> 
  </c:choose>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Nombre del cliente: <x:out select="$d//customer/name"/></font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<table width=660 cellspacing="0" cellpadding="5" indent=30  border="0" >
  <tr bgcolor="CC0000">
    ...
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Descripción del producto</font></th>
...
Para renovar sus suscripciones con Red Hat, póngase en contacto con <c:out value="${partner_text}"/> nosotros:
      </c:when>
      <c:otherwise>
Para renovar sus suscripciones con Red Hat, póngase en contacto con nosotros:
      </c:otherwise>
    </c:choose>
  </font></td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Las suscripciones de Red Hat le proporcionan un valor continuo a su negocio. Con las suscripciones de Red Hat activas tiene acceso a:
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Seguridad: </b>Nuestro equipo de ingeniería ha solucionado más del 98% de las vulnerabilidades críticas en el plazo de un día natural a partir de la identificación del problema.</li>
      <li><b>Soporte galardonado: </b>El soporte técnico de Red Hat está disponible 24 horas al día en todo el mundo. Además puede acceder a la base de conocimiento, a los casos prácticos y a las arquitecturas de referencia disponibles mediante el Portal de clientes de Red Hat.</li>
      <li><b>Actualizaciones: </b>Las suscripciones le dan acceso a cualquier versión soportada de software de Red Hat, incluidas las actualizaciones entre versiones.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Descubra todas las ventajas de las suscripciones a Red Hat en <br><a href ="http://www.redhat.com/about/subscription" >http://www.redhat.com/about/subscription</a></font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Gracias por escoger Red Hat.</font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
    <c:out value="${s_contact}"/><br>
    <c:out value="${s_email_preamble}"/>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Tenga esta información a mano cuando se ponga en contacto con nosotros:</font></td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Nombre del cliente: <x:out select="$d//customer/name"/></font></td></tr> 
...
<table width=660 cellspacing="0" cellpadding="5" indent=30  border="0" >
  <tr bgcolor="CC0000">
    ...
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Número de pedido</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Cantidad original</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Número de artículo (SKU) original</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Descripción original</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Cantidad nueva</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Número de artículo (SKU) nuevo</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Descripción nueva</font></th>
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Fecha de caducidad</font></th>
  </tr>
  <c:set var="pcount" value='0'/>
  <x:forEach select="$d/account/products/product" var="p">
...
© 2013 Red Hat, Inc. Todos los derechos reservados. Red Hat, Red Hat Enterprise Linux, el logotipo Shadowman y JBoss son marcas comerciales de Red Hat, Inc. registradas en Estados Unidos y en otros países. Linux® es la marca comercial registrada de Linus Torvalds en EE. UU. y en otros países. Las demás marcas registradas son propiedad de sus respectivos propietarios.
</font> </td></tr> 
</table>
