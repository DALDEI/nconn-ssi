...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "nl" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/NL_PARTNER_EXPIRED_-60.png"></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
De licenties voor de eindgebruikers zoals hieronder vermeld, zijn verstreken.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
De eindgebruikers die gecontacteerd mogen worden , zullen 90 dagen, 30 dagen en 7 dagen voordat de contracten aflopen per e-mail een herinnering ontvangen. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Uw contactgegevens zijn in de emails opgenomen. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Reseller</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Eind-gebruiker</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">SKU</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Product omschrijving</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Hoeveel-heid </font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Afloop datum</font></th>
  </tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Uw verantwoordelijke sales representative zal binnenkort contact met u opnemen om de hierboven genoemde contracten met u te bespreken en eventueel verdere informatie en/of support te verstrekken.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Mocht u in de tussentijd vragen hebben over het renewal proces, dan kunt u uiteraard te allen tijde contact met ons opnemen.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Met vriendelijke Groet, <br><b><x:out select="$d//opp_ssirep_fullname"/></b>
  </font></td></tr>
