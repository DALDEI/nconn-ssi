...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">
<b>귀하의 지브라 서비스 계약이 곧 만료됩니다.</b>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
고객의 발주서 계약 갱신을 위해 아래 서비스팩 만료 전에 재계약 진행을 해 주시면 감사하겠습니다.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
사이트를 방문하면 고객의 선택 사항을 확인할 수 있습니다. 
앞으로 경험하게 될 새로운 서비스와 서비스 옵션 및 이점도 살펴볼 수 있습니다. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
계약이 만료일 이전에 갱신되지 않을 경우 서비스가 중지될 수 있으므로, 
만료일 이전에 계약을 갱신할 수 있도록 고객에게 알려주시기 바랍니다. 
서비스가 중지되면 일부 서비스 기능을 이용할 수 없게 됩니다. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
아래는 고객님의 제품 가동 시간 및 가용성을 유지하는데 도움을 주는 
Zebra OneCare 서비스 기능의 일부입니다.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<table cellspacing="0" cellpadding="0" width="600" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
이러한 서비스를 이용할 수 없게 되면 고객의 비즈니스에 영향을 미칠 수 있습니다. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
문의 사항이 있거나 사용 가능한 옵션에 대해 알아보고 싶으시면 언제든지 문의하십시오. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
