...
<% nexstra.cds.servlet.TemplateTags.sendEvent( request , pageContext , "CustomEvent.contact" , null ); %>
	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>A representative from the F5 Renewals Team will contact you directly within the next 48 hours.  </p>
 <br />
 <br />
