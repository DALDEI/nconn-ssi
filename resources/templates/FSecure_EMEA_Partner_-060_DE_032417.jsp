...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "de" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/GER_PARTNER_EXPIRED_-60.png"></td></tr>
...
<%-- LETTER BODY --%>
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">Sehr geehrte Partner</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Folgende F-Secure Lizenzen Ihres unten aufgeführten Kunden sind abgelaufen.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Der Kunde bekam 90, 30 und 7 Tage vor Ablauf der Lizenzen eine Erinnerungsnachricht per E-Mail, sofern dies von Ihrer Seite gestattet wurde. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Ihre Kontaktinformationen wurden in diesen E-Mails aufgeführt. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">F-Secure Partner Name</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Endkunde Name</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">SKU</font></th>
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Produkt Name</font></th>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Ihr zuständiger F-Secure Ansprechpartner wird Sie in Kürze kontaktieren, um mit Ihnen den aktuellen Status zu besprechen und um Ihnen einen genauen Überblick über die Vertragsverlängerung und Upgrade-Optionen zu verschaffen.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Sollten Sie weitere Fragen bezüglich dem Verlängerungs-Prozess oder der Kundenkommunikation haben, zögern Sie bitte nicht uns jederzeit zu kontaktieren.
  ...
  <tr><td><font face="Arial" size="2">
Herzliche Grüße, <b><x:out select="$d//opp_ssirep_fullname"/></b>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
Ihr F-Secure Team
  </font></td></tr>
