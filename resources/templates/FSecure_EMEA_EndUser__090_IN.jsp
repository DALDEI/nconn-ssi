...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "en" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/ENG_EU_EXPIRING_90_60_30_7.png"></td></tr>
...
Thank you for using F-Secure security products. 
  ...
  <tr><td><font face="Arial" size="2">
According to our records the F-Secure licenses listed below are due to expire soon. 
Please renew your licenses in order to stay protected and receive product updates as well as support and maintenance services from F-Secure.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
