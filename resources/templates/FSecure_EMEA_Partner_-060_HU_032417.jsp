...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "hu" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/HUN_PARTNER_EXPIRED_-60.png"></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Az alábbi licencek lejártak.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
A végfelhasználó megújítási emlékeztető emaileket kapott 90,30 és 7 nappal a lejárat előtt, valamint 1 nappal a lejárat után.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Az Ön elérhetőségeit feltüntetettük az emailekben. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
A megújítási folyamat vagy a vásárlókkal való kommunikáció kapcsán felmerülő kérdés esetén kérjük, vegye fel velünk a kapcsolatot. 
  ...
  <tr><td><font face="Arial" size="2">
Üdvözlettel, <b><x:out select="$d//opp_ssirep_fullname"/></b>
  </font></td></tr>

  <tr><td><font face="Arial" size="2">
Az F-Secure megújítási csapata
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
