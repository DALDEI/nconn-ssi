...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "sv" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/SWE_T2RESELLER_EXPIRING_120.png"></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Följande Kundlicenser löper ut.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Slutkunder som är kontaktbara får förnyelsepåminnelse mejl 90 dagar, 30 dagar och 7 dagar före utgångsdatum. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<th  align="center" valign="center"><font face="Arial" size="2" color="ffffff">Distributör </font></th>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  ...
  <tr><td><font face="Arial" size="2">
Din dedikerade förnyelserepresentant kommer kontakta dig inom kort för att diskutera utlöpande licenseravtal och säkerställa att du har tillgång till stöd och information.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Tveka inte att kontakta oss om du har några frågor om förnyelseprocessen eller kundkommunikation. 
  ...
  <tr><td><font face="Arial" size="2">
Kontortelefon: <b><x:out select="$d//opp_ssirep_phone"/></b>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
