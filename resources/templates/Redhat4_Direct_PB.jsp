...
<tr><td><font face="Arial" size="2">
De acordo com nossas informações, sua subscrição Red Hat expirou. Por favor lembre-se de renová-las imediatamente para continuar recebendo os benefícios de suas subscrições, incluindo acesso ao nosso software Red Hat, atualizações, upgrades, suporte técnico, correções de segurança e ao Programa de Garantia de Código Aberto Red Hat. Por favor, verifique a nova oferta de Renovação pois nossos produtos mudaram.  Se você tiver alguma dúvida, eu sou seu Representante de Vendas Red Hat  e você pode enviar um email paraDe acordo com nossas informações, sua subscrição Red Hat expirou. Por favor lembre-se de renová-las imediatamente para continuar recebendo os benefícios de suas subscrições, incluindo acesso ao nosso software Red Hat, atualizações, upgrades, suporte técnico, correções de segurança e ao Programa de Garantia de Código Aberto Red Hat. Por favor, verifique a nova oferta de Renovação pois nossos produtos mudaram.  Se você tiver alguma dúvida, eu sou seu Representante de Vendas Red Hat  e você pode enviar um email para
<x:choose><x:when select="$d//subbatch [ . = 'ServiceSource' ]"><a href=mailto:<x:out select="$d//ssirep/email"/>><x:out select="$d//ssirep/email"/></a></x:when><x:otherwise><a href=mailto:<x:out select="$d//client/rep_email"/>><x:out select="$d//client/rep_email"/></a></x:otherwise></x:choose><BR>&nbsp;<BR>
</font></td></tr>
...
<tr><td><font face="Arial" size="2">
Abaixo você poderá encontrar o mapeamento de sua subscrição atual :</font></td></tr>
...
<tr><td><font face="Arial" size="2">
Em caso de dúvidas ou para mais informações, por favor, entre em contato através do telefone: <x:choose><x:when select="$d//subbatch [ . = 'ServiceSource' ]"><x:out select="$d//ssirep/phone"/></x:when><x:otherwise><x:out select="$d//client/rep_tel"/></x:otherwise></x:choose>.
<BR><BR></font></td></tr>
