...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "it" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/ITA_EU_EXPIRED_-60.png"></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
Prima di tutto desideriamo ringraziarLa per aver scelto di utilizzare i prodotti F-Secure. 
  ...
  <tr><td><font face="Arial" size="2">
A seguito di un controllo sul nostro database, alla data di emissione di questa lettera risulta che le licenze F-Secure elencate di seguito sono scadute. Vi chiediamo gentilmente di rinnovare le stesse per rimanere protetti e ricevere gli aggiornamenti e il supporto necessario.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
