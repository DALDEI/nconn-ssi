...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    <c:when test="${tpl_stage == 'minus30'}"> 
      <tr><td><font face="Arial" size="2">As subscrições da Red Hat à seguir venceram.</font></td></tr> 
    </c:when>
    <c:when test="${tpl_stage == '0'}"> 
      <tr><td><font face="Arial" size="2">As subscrições da Red Hat à seguir vencem hoje.</font></td></tr> 
    </c:when>
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">As subscrições da Red Hat à seguir vencerão em <c:out value="${tpl_stage}"/> dias.</font></td></tr>
    </c:otherwise> 
  </c:choose>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Você pode renovar suas Subscrições da Red Hat  entrando em contato por:</font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Suas subscrições da Red Hat lhe proporcionam um valor contínuo, colaborando com os seus negócios todos os dias. Somente com as subscrições ativas da Red Hat você tem acesso a:</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Segurança: </b>a Equipe líder em segurança da Red Hat forneceu correções para mais de 98% das vulnerabilidades críticas dentro de um dia após terem sido identificadas.</li>
      <li><b>Suporte premiado:  </b>o suporte técnico da Red Hat está disponível 24 por dia no mundo todo, com base de conhecimento, estudos de caso e arquiteturas de referência disponíveis através do Portal do cliente da Red Hat.</li>
      <li><b>Atualizações e upgrades grátis:  </b>sua subscrição lhe dá acesso a qualquer versão compatível do software da Red Hat, incluindo todas as atualizações a estas versões.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Você pode descobrir mais sobre os benefícios de sua subscrição na Red Hat em  <a href ="http://www.redhat.com/about/subscription" >http://www.redhat.com/about/subscription</a>.</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Agradecemos por escolher a Red Hat.</font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
    <c:out value="${s_contact}"/><br>
    <c:out value="${s_email_preamble}"/>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Ao entrar em contato conosco, tenha disponível com você as seguintes informações:</font></td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Nome do cliente – <x:out select="$d//customer/name"/></font> </td></tr> 
