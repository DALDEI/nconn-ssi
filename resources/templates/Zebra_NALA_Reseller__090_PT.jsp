...
onde irá encontrar as opções disponíveis para o seu cliente. Existem novos 
serviços, novas opções de serviço e novos benefícios a experimentar.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Não deixe que o seu cliente adie a renovação de contrato até ao último 
dia de expiração ou para depois - isso resultará em que os serviços sejam 
interrompidos caso o contrato não seja renovado antes da sua data de 
expiração. O seu cliente irá deixar de ter acesso a funcionalidades da 
sua oferta de serviço específica.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
As funcionalidades de serviço listadas abaixo fazem parte da oferta 
Zebra OneCare que mantém os níveis de execução e disponibilidade 
de produto desejados pelos seus clientes.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
anteriormente. Se nunca iniciou sessão no nosso portal de parceiro, 
não hesite em contactar-me para obter ajuda.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
