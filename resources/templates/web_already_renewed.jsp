...
<% nexstra.cds.servlet.TemplateTags.sendEvent( request , pageContext , "CustomEvent.already_renewed" , null ); %>
	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>A representative from the F5 Renewals Team will contact you within the next 48 hours to get the details of your renewal.  </p>
 <br />
 <br />
