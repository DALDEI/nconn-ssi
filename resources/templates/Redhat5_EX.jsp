...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    <c:when test="${tpl_stage == 'minus30'}"> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones Red Hat expiraron.</font></td></tr> 
    </c:when>
    <c:when test="${tpl_stage == '0'}"> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones Red Hat expiran hoy.</font></td></tr> 
    </c:when>
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones Red Hat expirarán en <c:out value="${tpl_stage}"/> días.</font></td></tr>
    </c:otherwise> 
  </c:choose>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table width=660 cellspacing="0" cellpadding="5" indent=30  border="0" >
  <tr bgcolor="CC0000">
    ...
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">Fecha de expiración</font></th>
  </tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Puede renovar sus suscripciones contactándose con Red Hat al:</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Sus suscripciones Red Hat le proporcionan valor continuo que le ayuda en sus negocios a diario. 
Sólo con sus suscripciones activas de Red Hat usted tiene acceso a:
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Seguridad: </b>el equipo de respuesta de seguridad de Red Hat ha entregado soluciones a más del 98% de vulnerabilidades críticas en un día calendario, desde el momento en que son identificadas.</li>
      <li><b>Soporte galardonado: </b>el soporte técnico de Red Hat está disponible las 24 horas del día a nivel mundial, con la base de conocimientos, estudios de caso y las arquitecturas de referencia disponibles a través del Portal del cliente de Red Hat.</li>
      <li><b>Actualizaciones y mejoras gratuitas: </b>la suscripción le da acceso a cualquier versión compatible del software de Red Hat, incluyendo todas las actualizaciones para estas versiones.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Usted puede obtener más información sobre las ventajas de su suscripción Red Hat en  <br>
<a href ="http://www.redhat.com/about/subscription" >http://www.redhat.com/about/subscription</a>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Gracias por elegir a Red Hat.</font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
    <c:out value="${s_contact}"/><br>
    <c:out value="${s_email_preamble}"/>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Tenga a mano la siguiente información cuando nos contacte:</font></td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Nombre del cliente: <x:out select="$d//customer/name"/></font></td></tr> 
  <tr><td><font face="Arial" size="2">Nombre de la cuenta: <x:out select="$d//acct_no"/></font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
<table width=660 cellspacing="0" cellpadding="5" indent=30  border="0" >
  <tr bgcolor="CC0000">
    ...
    <th align="center" valign="center"><font face="Arial" size="2" color="ffffff">SKU nuevo</font></th>
...
© 2013 Red Hat, Inc. Todos los derechos reservados. Red Hat, Red Hat Enterprise Linux, el logotipo de Shadowman,  y JBoss son marcas comerciales de Red Hat, Inc., registradas en los Estados Unidos y en otros países. Linux® es la marca comercial registrada de Linus Torvalds en los Estados Unidos y en otros países. Todas las demás marcas son propiedad de sus respectivos dueños.
</font> </td></tr> 
</table>
