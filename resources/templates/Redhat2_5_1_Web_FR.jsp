...
<tr><td><font face="Arial" size="2"><br>Je vous remercie d'avoir choisi les solutions de Red Hat.
 <br> <br> </font></td></tr> 
...
<tr><td><font face="Arial" size="2"> 
<BR>
Afin de vous permettre de beneficier de la valeur des souscriptions de facon optimale, nous tenons a vous offir la possibilite de discuter vos besoins avec un partenaire Red Hat de confiance. Pour utiliser ce service, veuillez nous faire parvenir un courriel (<a href=mailto:renewals-emea@redhat.com>renewals-emea@redhat.com</a>) et notre equipe en charge du Renouvellement vous mettra en relation avec le partenaire approprie. Autrement, si vous etes certain de comprendre les souscriptions requises, veuillez cliquer ici:
<br>&nbsp;<BR>


<a href ="https://www.redhat.com/apps/store/renew/" > <img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/redhat2/button_renew_now_FR.gif" border=0> </a> <br><br></font> </td></tr> 
...
<tr><td><font face="Arial" size="2">
<BR> Le tableau suivant montre le mappage de votre abonnement actuel vers notre nouvelle structure de produit, qui vous sera accessible dès que vous renouvèlerez votre abonnement:
 <BR>&nbsp;<BR>
</font></td></tr>
...
<tr><td><font face="Arial" size="2">Si vous pensez que quelqu'un d'autre pourrait être intéressé pour recevoir des avis au sujet de vos abonnements Red Hat, veuillez envoyer un courriel contenant ces informations à <a href=mailto:renewals-emea@redhat.com >renewals-emea@redhat.com</a>. Veuillez vous assurer d'inclure votre ID de connexion Red Hat et votre numéro de contrat.  <BR>
</font><br></td></tr>
