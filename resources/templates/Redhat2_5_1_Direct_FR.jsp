...
<tr><td><font face="Arial" size="2">Si vous pensez que quelqu'un d'autre pourrait être intéressé pour recevoir des avis au sujet de vos abonnements Red Hat, veuillez envoyer un courriel contenant ces informations à <a href=mailto:customerdata-emea@redhat.com > customerdata-emea@redhat.com </a>
Veuillez vous assurer d'inclure votre ID de connexion Red Hat et votre numéro de contrat. 
 <BR>
</font><br></td></tr>
