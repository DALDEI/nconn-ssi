...
Kind Regards,
  ...
  <tr><td><font face="Arial" size="2">
APAC Contract Services Renewal Team
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
<a href=mailto:apac.renewals@zebra.com>APAC.renewals@zebra.com</a>
  ...
  <tr><td><font face="Arial" size="2">
If you do not prefer to receive email renewal notifications from Zebra, please <a href='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "Zebra_Unsubscribe_Acknowledgement_IN" ) %>'>click here to unsubscribe.</a>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
