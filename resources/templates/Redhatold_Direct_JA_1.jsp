...
<tr><td><font face="Arial" size="2"><br>ご使用いただいておりましたサブスクリプションでご利用できるサービス及び更新に必要な情報の詳細は<a href ="http://jp.redhat.com/about/subscription/" >こちら</a>でご覧いただけます。
</font></td></tr>

<tr><td><font face="Arial" size="2"><br>レッドハットサブスクリプションについて、今後、ご連絡を差し上げるべき方が他にいらっしゃいましたら、恐れ入りますが、ご連絡先を<a href=mailto:soc-jp@redhat.com >soc-jp@redhat.com</a>
