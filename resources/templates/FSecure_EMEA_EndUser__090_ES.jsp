...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "es" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
     <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/ESP_EU_EXPIRING_90_60_30_7.png"></td></tr>
...
Le agradecemos por usar los productos de seguridad de F-Secure. 
  ...
  <tr><td><font face="Arial" size="2">
De acuerdo con nuestros registros, las licencias F-Secure listadas abajo van a expirar próximamente. Por favor renueve sus licencias para permanecer protegido, así como recibir actualizaciones y servicios de soporte y mantenimiento de F-Secure.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Por favor entre en contacto con su Revendedor F-Secure por teléfono, o vía e-mail para renovar las licencias y obtener más informaciones sobre nuestros productos y servicios. 
  ...
  <tr><td><font face="Arial" size="2">
Si usted recientemente ha renovado sus licencias, por favor ignorar este aviso. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Detalles de Contacto del Revendedor:
  ...
  <tr><td><font face="Arial" size="2">
En el caso de cualquier duda referente al proceso de renovación o comunicación, por favor pónganse en contacto.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  ...
  <tr><td><font face="Arial" size="2">F-Secure Equipo de Renovaciones</font></td></tr>
  <tr><td><font face="Arial" size="2">
