...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    <c:when test="${tpl_stage == 'minus30'}">
      <tr><td><font face="Arial" size="2">以下のお客様のRed Hatサブスクリプションの有効期間はすでに終了しております。</font></td></tr>
    </c:when>
    <c:when test="${tpl_stage == '0'}"> 
      <tr><td><font face="Arial" size="2">以下のお客様のRed Hatサブスクリプションの有効期限は本日までです。</font></td></tr> 
    </c:when>
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">以下のお客様のRed Hatサブスクリプションの有効期間はあと<c:out value="${tpl_stage}"/> 日間です。</font></td></tr>
    </c:otherwise> 
  </c:choose>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Red Hatサブスクリプションの更新及びお問い合わせの際は、下記までご連絡下さい。</font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
ご更新の手続きが遅れますと、そのご契約の有効期限の翌日までご更新の開始日を遡る場合がございますのでご注意下さい。
  ...
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>セキュリティ: </b>Red HatのSecurity Response Team では、問題の98%以上を報告された日の翌日中に修正してきた実績があります。</li>
      <li><b>受賞歴のあるサポート: </b>Red Hatテクニカルサポートは、グローバルに24時間稼働しています。また、Red Hatカスタマーポータル経由でナレッジベース、ケーススタディやリファレンスアーキテクチャを活用できます。</li>
      <li><b>無償のアップデートおよびアップグレード: </b>サブスクリプションをお持ちの場合、サポート期間内のRed Hatソフトウェア及びすべてのアップグレードに関してのサービスの提供を受けられます。</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Red Hatサブスクリプションのメリットについて詳しくは以下をご覧ください。 <a href ="http://www.redhat.com/about/subscription" >http://www.redhat.com/about/subscription</a>.</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
© 2013 Red Hat, Inc. All rights reserved. Red Hat、Red Hat Enterprise Linux、Shadowmanロゴ、およびJBossは、米国およびその他の国におけるRed Hat, Inc.の登録商標です。Linux®は、米国およびその他の国におけるLinus Torvalds氏の登録商標です。その他の商標は該当する各社が所有しています。
