...
Al fine di aiutarvi a capire quali sottoscrizzioni vi occorrono, saremmo lieti di darvi la possibilta' di discutere le vostre esigenze con uno dei nostri Partner di fiducia. Per usufruire di questa opportunita', e' sufficiente  rispondere a questa email (<a href=mailto:renewals-emea@redhat.com >renewals-emea@redhat.com</a>) e il nostro Team vi mettera' in contatto con il Partner piu' appropriato. Viceversa, se ritenete di non avere bisogno di supporto nel valutare quali subscriptions vi sono necessarie, potete cliccare qui per: 
...
<tr><td><font face="Arial" size="2"> 
<BR>&nbsp;<BR>
<a href ="https://www.redhat.com/apps/store/renew/" > <img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/redhat2/button_renew_now_IT.gif" border=0> </a> <br><br></font> </td></tr> 
...
<tr><td><font face="Arial" size="2">
<BR>
La tabella seguente mostra la corrispondenza della sua attuale sottoscrizione alla struttura del nostro nuovo prodotto, che le sarà rilasciato al momento del rinnovo della sua sottoscrizione:<BR>&nbsp;<BR>
</font></td></tr>
...
<tr><td><font face="Arial" size="2">
Per maggiori informazioni sui vantaggi e sui requisiti del rinnovo della sua sottoscrizione Red Hat faccia clic
 <a href ="http://www.redhat.com/subscriptions/" >qui</a>.
</font><br><br></td></tr>
<tr><td><font face="Arial" size="2">


Se ritiene che qualcun altro dovrebbe ricevere queste notifiche in futuro riguardo le sottoscrizioni Red Hat,  invii i relativi dati via e-mail a <a href=mailto:renewals-emea@redhat.com >renewals-emea@redhat.com</a>. Si assicuri di inserire il suo Red Hat Login ID e il suo numero di contratto.<br><br><br></font></td></tr>

<tr><td><font face="Arial" size="2"> 
Distinti saluti,<br><br><br></font>  </td></tr>
