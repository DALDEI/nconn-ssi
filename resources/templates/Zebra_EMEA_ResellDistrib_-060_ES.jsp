...
<img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/ES_Serv_Contract_Exp.png">
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
<b>ES NECESARIA SU INTERVENCIÓN URGENTE</b>
  </center></font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
Estimado Cliente,
  ...
  <tr><td><font face="Arial" size="2">
Le informamos de que los contratos de servicio enumerados más abajo han caducado y ya no recibirá servicio de soporte para los productos Zebra asociados. Tenga en cuenta que, si opta por renovar el contrato de servicio caducado, Zebra aplicará a su cliente directo una Tarifa de continuidad de servicio del 10% del valor de renovación anual presupuestado de cada contrato de servicio caducado, hasta un máximo de 50.000 USD.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
Todos los dispositivos que anteriormente estaban cubiertos por un contrato de soporte quedarán sujetos a partir de ahora a las condiciones de cobro por tiempo y materiales que se deriven de la reparación de cada dispositivo. Zebra necesitará al menos 10 días desde la recepción de un pedido válido de compra de tiempo y materiales para reparar cada dispositivo afectado. En la mayoría de los casos, la modalidad de pago por tiempo y materiales resulta más costosa y excluye toda la gama de ventajas que comporta la renovación del contrato de servicio.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
<b>Para reanudar la cobertura del servicio y seguir disfrutando de sus ventajas, deberá renovar su contrato de servicio de inmediato.</b> La renovación del contrato de servicio dentro del plazo garantiza que la inversión seguirá estando protegida gracias a:
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
Ya hemos preparado un resumen de renovación para usted en nuestro sitio de renovaciones de contratos: <a href="http://renewals.connectpartnerportal.com/">http://renewals.connectpartnerportal.com/</a>. Inicie una sesión utilizando los datos de usuario que le suministramos anteriormente. Si nunca ha iniciado una sesión en el portal de partners, no dude en ponerse en contacto con nosotros para obtener ayuda.
  ...
  <tr><td><font face="Arial" size="2">
Si desea renovar el contrato de servicio caducado, póngase en contacto con nosotros y le facilitaremos todos los datos que necesita para ello.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
