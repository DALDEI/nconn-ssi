...
<%= nexstra.cds.servlet.TemplateTags.formatLongDate( pageContext , null, "mm/dd/yy" , "tr" , "" ) %>
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr align="center" valign="top"><td><img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/fsecure/TR_EU_EXPIRED_-60.png"></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
...
F-Secure Güvenlik ürünlerini tercih ettiğiniz için teşekkür ederiz.
  ...
  <tr><td><font face="Arial" size="2">
Kayıtlarımıza göre aşağıda listelenen F-Secure lisansları sona ermiş bulunmaktadır. Korumalı kalmak ve F-Secure ürün güncellemelerinin yanı sıra destek ve bakım hizmetlerini alabilmek için lütfen lisanslarını yenileyiniz.
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
</table>
