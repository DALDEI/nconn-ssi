	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<tr>
		    <td>
                ...
                <br /><br />
 <p>Puede por favor especificar la razon por la cual su empresa ha decidido no renovar?</p>
 <br />
 <br />
		...
		<input name="_event" type="hidden" size="40" value="FormEvent.no_renewal">		  	  
				  <input name="_redirect" type="hidden" size="40" value='<%=nexstra.cds.servlet.TemplateTags.getTemplateURL( request , pageContext , "web_norenew_thankyou_ES" ) %>'>
                  <table>
				  <tr>
				  <td></td><td>
<select size="1" name="no_service_code">
<option value="SCB" SELECTED>Decision del cliente relativa al Coste-Beneficio</option>
<option value="SSD">Decision motivada por la satisfaccion del usuario</option>
<option value="PPD">Producto Descatalogado</option>
<option value="PTR">Reemplazo del producto a traves del cliente</option>
<option value="PCP">Reemplazo del producto a traves de la competencia</option>
</select>
