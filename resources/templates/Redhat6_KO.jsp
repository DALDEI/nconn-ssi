...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">귀사의 아래Red Hat 서브스크립션이 <c:out value="${tpl_stage}"/>일 후 
...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Red Hat 서브스크립션은 귀사의 일상적인 비즈니스를 지원하는 지속적인 가치를 제공해

드립니다. 유효한 Red Hat 서브스크립션을 통해 아래와 같은 혜택을 받으실 수 있습니다.</font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>보안: </b>Red Hat 보안 팀에서는 심각한 보안 취약점에 대해 98% 이상의 발견율을 자랑하며 발견 후 하루 이내에 

보안 수정 내용을 제공해 왔습니다.</li>
      <li><b>수상 경력에 빛나는 지원: </b>Red Hat의 기술 지원은 전 세계에 상시 제공되는 서비스로, Red Hat 고객 포털을 통해 

사용 가능한 지식베이스, 사례 연구 및 참조 아키텍처 등을 지원하고 있습니다.</li>
      <li><b>무료 업데이트 및 업그레이드: </b>서브스크립션을 통해 Red Hat 소프트웨어를 지원하는 모든 버전에 액세스할 수 

있으며 여기에는 해당 버전에 대한 모든 업데이트가 포함됩니다.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>

  <tr><td><font face="Arial" size="2">
다음 링크를 통해 Red Hat 서브스크립션의 다양한 혜택에 대해 보다 자세히 알아보실 수 있습니다. 
  </font></td></tr>
  <tr><td><font face="Arial" size="2">
<a href ="http://red.ht/1EGEUMm" >http://red.ht/1EGEUMm</a>
  ...
  <tr><td><font face="Arial" size="2">Red Hat을 선택해 주셔서 감사합니다.</font> </td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
    <c:out value="${s_contact}"/><br>
    <c:out value="${s_email_preamble}"/>
...
© 2015 Red Hat, Inc. All Rights Reserved.  Red Hat, Red Hat Enterprise Linux, Shadowman 로고 및 JBoss는 미국 및 기타 

국가에서 Red Hat, Inc.의 등록 상표입니다. Linux®는 미국 및 기타 국가에서 Linus Torvalds의 등록 상표입니다. 기타 모든 상표
