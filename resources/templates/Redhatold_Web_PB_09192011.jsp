...
<c:otherwise> 
<tr><td><font face="Arial" size="2">
<BR>De acordo com nossas informações, sua subscrição Red Hat vai EXPIRAR EM <c:out value="${stage}"/> DIAS. Por favor certifique-se em renova-las antes da data de expiração para que você continue a recebendo os benefícios de suas subscrições, incluindo acesso ao nosso software Red Hat, atualizações, upgrades, suporte técnico, correções de segurança e ao Programa de Garantia de Código Aberto Red Hat. Por favor certifique-se de ler os termos abaixo para entender os termos da sua oferta de renovação porque as as configuraçoes do nosso produto mudaram.</font></td></tr>
...
Abaixo você poderá encontrar o mapeamento de sua subscrição atual referente ao novo produto que você receberá com sua renovação:
<BR>&nbsp;<BR>
