...
<c:otherwise> 
<tr><td><font face="Arial" size="2">
Segundo os nossos registos, as suas subscrições Red Hat irão EXPIRAR DENTRO DE <c:out value="${stage}"/> DIAS. Certifique-se de que as renova antes da data de expiração para continuar a beneficiar das vantagens das suas subscrições. Por favor, certifique-se de que as renova antes da data de expiração para continuar a receber os benefícios da sua subscrição, incluindo o acesso ao software Red Hat, actualizações, apoios técnicos, soluções de segurança e ao programa de garantia de fonte aberta da Red Hat. Certifique-se de que lê os termos a seguir, de compreender totalmente os termos de oferta da sua renovação e como as configurações do nosso produto foram modificadas. </font></td></tr>
</c:otherwise>
</c:choose>

<tr><td><font face="Arial" size="2">
<br>Para obter se beneficiar  ao maximo de nossas subscrições, gostaríamos de lhe oferecer a oportunidade de discutir suas necessidades com uma pessoa de confiança do nosso Red Hat Partner programa. Para utilizar este serviço, por favor responda enviando-nos um e-mail (<a href="renewals-emea@redhat.com">renewals-emea@redhat.com</a>) e nossa equipe de renovações irá conecta-lo com um parceiro específico. Caso estejas confidente que compreendes o sistema de subscrições, por favor clicar aqui para: </font></td></tr>


<tr><td><font face="Arial" size="2"> 
<BR>&nbsp;<BR>
<a href ="https://www.redhat.com/apps/store/renew/" > <img src="https://nexstra-com-resources.s3.amazonaws.com/cds/ssi/images/redhat2/button_renew_now_PT.gif" border=0> </a> <br><br></font> </td></tr> 
...
<b>Apoio técnico: </b>utilize níveis de apoio de acordo com as suas necessidades.<li>
...
<tr><td><font face="Arial" size="2">Se considera que outra pessoa deve receber futuras informações sobre as suas subscrições Red Hat, envie um e-mail com os detalhes para  <a href=mailto:renewals-emea@redhat.com >renewals-emea@redhat.com</a>.
Certifique-se de incluir a sua identificação de início de sessão e o número do seu contrato.<br><br><br></font></td></tr>
