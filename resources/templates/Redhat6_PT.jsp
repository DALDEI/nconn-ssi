...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">As subscrições da Red Hat abaixo vencerão em <c:out value="${tpl_stage}"/> 
...
Somente com as subscrições ativas da Red Hat você tem acesso a:
  ...
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Segurança: </b>a equipa de segurança da Red Hat forneceu correções para mais de 98% das vulnerabilidades 

críticas no espaço de um dia após terem sido identificadas.</li>
      <li><b>Suporte premiado:  </b>o suporte técnico da Red Hat está disponível 24 horas por dia em todo o mundo, com 

base de conhecimento, casos de estudo e arquiteturas de referência disponíveis através do Portal de Cliente da Red 

Hat.</li>
      <li><b>Atualizações e upgrades grátis: </b>a sua subscrição dá-lhe acesso a qualquer versão compatível do software 

da Red Hat, incluindo todas as atualizações a estas versões.
</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
Você pode descobrir mais sobre os benefícios de da sua subscrição na Red Hat em 
<a href ="http://red.ht/1EGEUMm" >http://red.ht/1EGEUMm</a>
  ...
  <tr><td><font face="Arial" size="2">Ao entrar em contato connosco, tenha disponível com você as seguintes 

informações:</font></td></tr> 
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">Nome do cliente – <x:out select="$d//customer/name"/></font> </td></tr> 
