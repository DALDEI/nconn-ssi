...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Le seguenti sottoscrizioni Red Hat scadranno tra <c:out value="${tpl_stage}"/> giorni.</font></td></tr>
    </c:otherwise> 
  </c:choose>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
la sua azienda. Solo attivando la sottoscrizione Red Hat puo' accedere a:
  ...
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li><b>Sicurezza: </b>ad oggi il Red Hat Security Response Team ha corretto oltre il 98% delle vulnerabilità critiche entro un giorno di calendario dall'identificazione.</li>
      <li><b>Pluripremiato servizio di supporto: </b>il supporto tecnico Red Hat è disponibile 24 ore al giorno in tutto in mondo. Puoi consultare la Knowledge Base, i casi studio e le architetture di riferimento tramite il portale clienti di Red Hat.</li>
      <li><b>Aggiornamenti gratuiti: </b>la sottoscrizione Red Hat ti consente di accedere a tutte le versioni supportate del software Red Hat e ai relativi aggiornamenti.</li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">
...
<a href ="http://www.redhat.com/about/subscription" >http://www.redhat.com/about/subscription</a>.
  ...
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
  <tr><td><font face="Arial" size="2">La preghiamo di fornirci le seguenti informazioni nel momento in cui ci contatta:</font> </td></tr> 
  <tr><td><font face="Arial" size="2">Nome cliente - <x:out select="$d//customer/name"/></font> </td></tr> 
...
© 2013 Red Hat, Inc. Diritti riservati. Red Hat, Red Hat Enterprise Linux, il logo Shadowman e JBoss sono marchi di Red Hat, Inc., registrati negli Stati Uniti e in altri Paesi. Linux® è un marchio registrato di Linus Torvalds negli Stati Uniti e in altri Paesi. Tutti gli altri marchi appartengono ai rispettivi proprietari.
  </font> </td></tr> 
</table>
