...
<tr><td style="font-family:Calibri,sans-serif;font-size:10pt">Subject: My company has decided not to renew<br><br></td></tr>
...
<table style="width:500pt" cellpadding="0" cellspacing="0" border="0">
<tr><td style="font-family:Calibri,sans-serif;font-size:10pt"><br><br>Our company does not plan to renew maintenance for these appliances for the following reason:<br><br>
${values.no_service_code}<br><br></td></tr>
<tr><td style="font-family:Calibri,sans-serif;font-size:10pt">Comments: 
${values.comments}<br><br></td></tr>
