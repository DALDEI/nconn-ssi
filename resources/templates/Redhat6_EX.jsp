...
<table cellspacing="0" cellpadding="0" width="660" border="0">
  <c:choose>
    ...
    <c:otherwise> 
      <tr><td><font face="Arial" size="2">Las siguientes suscripciones Red Hat expirarán en <c:out value="${tpl_stage}"/> 
...
Sólo con sus suscripciones activas de Red Hat usted tiene acceso a:
  ...
  <tr><td><font face="Arial" size="2"> 
    <ul>
      <li>
<b>Seguridad: </b>el equipo de respuesta de seguridad de Red Hat ha entregado soluciones 
a más del 98% de vulnerabilidades críticas en un día calendario, desde el momento en que son identificadas.
      </li>
      <li>
<b>Soporte galardonado: </b>el soporte técnico de Red Hat está disponible las 24 horas del 
día a nivel mundial, con la base de conocimientos, estudios de caso y las arquitecturas de 
referencia disponibles a través del Portal del cliente de Red Hat.
      </li>
      <li>
<b>Actualizaciones y mejoras gratuitas: </b>la suscripción le da acceso a cualquier versión 
compatible del software de Red Hat, incluyendo todas las actualizaciones para estas versiones.
      </li>
    </ul>
  </font></td></tr>
  <tr><td><font face="Arial" size="2">&nbsp;</font></td></tr>
...
© 2015 Red Hat, Inc. Todos los derechos reservados. Red Hat, Red Hat Enterprise Linux, el logotipo de Shadowman,  y 

JBoss son marcas 

comerciales de Red Hat, Inc., registradas en los Estados Unidos y en otros países. Linux® es la marca comercial 

registrada de Linus 

Torvalds en los Estados Unidos y en otros países. Todas las demás marcas son propiedad de sus respectivos dueños.
</font> </td></tr> 
</table>
